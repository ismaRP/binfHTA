...
This is seen on the following screenshot with the first exon starting on the right and running to the left. The sequence CCTTT is reserve complemented and gives AAAGG.
...
The first 5 nucleotides from the GenBank sequence is gaagcaa. This is seen in the screenshot below:

![](AK002007_GeneBank.png)

In the above screenshot, the 7 nucleotides which are different between the UCSC browser and the GenBank entry are highlighted in blue.
