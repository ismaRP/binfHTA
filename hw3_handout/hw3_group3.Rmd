...
Pseudocounts are useful because they do not affect large numbers but help smooth the data when there are small values. In this particular case, the use of a pseudocount of 1 followed by a log2 transformation has the advantage avoids the $-\infty$ that would be produced by log2(0).
